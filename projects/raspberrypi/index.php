...
<html>
<head>
  <title>Zachary S RaspberryPi</title>
  <meta charset="utf-8">
  ...
  <link rel="stylesheet" type="text/css" href="css/raspberrypi.css">
  ...
  <style>
    ...
    button {
      ...
      color: #ffffff;
      border-color: rgb(130, 146, 235);
    }
    p,ul {
      font-size: 1em;
      margin: 0.5em;
      border: 0.3em solid #002699;
      padding: 1.2em;
...
<div class="w3-light_blue">
  ...
  <div class="grid-container">
    <div id="header">
      ...
      <div id="headText">
        <h1>RaspberryPi and Arduino Projects</h1>
        <h2>These projects have included networking, pulse width modulation, sensors, and op amps.<br><b>Click on the div headers to see projects</b></h2>
      </div>
      <br>
    </div>
    <div id="AdvComp" class="projects">
      <h3 class="projectHead" id="mysqltop">The Basics</h3>
