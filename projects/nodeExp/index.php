...
<div class="w3-light_blue">
  ...
  <div class="grid-container">
    <div id="header">
      ...
      <div id="headText">
        <h1>How to install Node</h1>
        <h2>This installation will include node.js and npm.<br><b>Click on the div headers to see instructions</b></h2>
      </div>
      <br>
    </div>
    <div id="AdvComp" class="projects">
      <h3 class="projectHead" id="mysqltop">How to install node.js from the website</h3>
      <img class="MySQL" src="images/nodejs.png" alt="MySQL1"></img>
      ...
      <img class="MySQL" src="images/testfileNode.png" alt="MySql2"></img>
    ...
    <div id="AdvWeb" class="projects">
      <h3 class="projectHead" id="phpmyadmintop">How to install node.js through the command line</h3>
      <img class="phpmyadmin" src="images/nodeJsCommand.png" alt="phpmyadmin1"></img>
      ...
      <img class="phpmyadmin" src="images/testfileNode.png" alt="MySql2"></img>
    ...
    <div id="about">
      <h3 class="projectHead" id="Workbenchtop">How to install npm</h3>
      <img class="Workbench" src="images/npmInstall.png" alt="Workbench1"></img>
